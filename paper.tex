...
%Data is loaded from the given SPARQL endpoint using fetch commands.
...
\todo{thomas: bitte tabelle vervollständigen}

OSMoSys is also a web application and handles large graphs using a level-of-detail system.
