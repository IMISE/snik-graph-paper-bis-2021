...
\subsection*{Role Use}
\todo{describe role use here}
\cref{fig:classuse}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{class-use-project-manager.pdf}
...
\begin{figure}[h!]
    ...
    \caption{\emph{Spiderworm} between \aurl{bb}{PatientIdentificationNumber} and \aurl{bb}{QualityOfData}.}
	\label{fig:path}
\end{figure}
\vspace{-3pt}
