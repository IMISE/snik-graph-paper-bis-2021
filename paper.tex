...
\todo{thomas continues the use cases from the book (only list those that are supported)}
...
\subsection*{Role Use}
\todo{konrad an alle: was mache ich mit der sparql query? rausschmeissen, drin lassen oder umbauen?}
\begin{figure}[h]
\begin{lstlisting}
